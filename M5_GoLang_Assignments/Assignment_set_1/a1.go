...
func main() {
	...
	_ = AddEmployee(1, "Kannan", 25, HR)
	_ = AddEmployee(2, "Kiran", 30, IT)
	_ = AddEmployee(3, "Priyanka", 22, IT)
	_ = AddEmployee(4, "Divya", 29, Sales)

	fmt.Println("=== Employee Management System ===")

	// 1. Add Employee
	fmt.Println("\nAdding Employee...")
	err := AddEmployee(5, "Sneha", 21, HR) // Valid age
	println("Succesfully added")
	if err != nil {
		fmt.Println("Error:", err)
	}
	fmt.Println("\nAdding Employee...")
	err1 := AddEmployee(5, "Priya", 13, HR) // Invalid age
	if err1 != nil {
